# Start Rojo for the Farm place (farm.project.json). Requires Rojo 7.7.0.
param(
...
Write-Host "Serving Farm with $RojoExe" -ForegroundColor Cyan
& $RojoExe --version
Set-Location $root
& $RojoExe serve farm.project.json
